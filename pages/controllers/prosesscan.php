                    ...
                    if(true){
                        echo '
                            <script>
                                ...
                                .then(function() {
                                    window.location = "http://localhost/Tugas%20Kuliah/Semester%207%20(Skripsweet)/Similarity_Checker/pages/?page=detailplagiarisme";
                                });
                            </script>
                        ';
                    }else{
                        echo '
                            <script>
                                ...
                                .then(function() {
                                    window.location = "http://localhost/Tugas%20Kuliah/Semester%207%20(Skripsweet)/Similarity_Checker/pages/?page=plagiarisme";
                                });
                            </script>
                        ';
                    }
