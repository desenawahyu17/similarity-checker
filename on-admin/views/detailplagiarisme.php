...
for($a = 0; $a < count($list_fingerprint); $a++){
	...
	array_push($data_urutDSC, [
		"title" => $title[$a],
		"file_size" => $file_size[$a],
		"content" => $content[$a],
		"similarity" => $jaccard,
	]);
}
array_multisort(array_column($data_urutDSC, "similarity"), SORT_DESC, $data_urutDSC);
                    ...
                    <tbody class="read-more-less" data-id="200">
                        ...
                        ?>
                            <tr>
                                ...
                                <td width="10%" align="center"><?php echo $data_urutDSC[$i]["title"] ?></td>
                                <td width="10%" align="center"><?php echo $data_urutDSC[$i]["file_size"] ?> byte</td>
                                <td width="48%" align="justify" class="read-toggle" data-id="<?php echo $data->nim ?>"><p class="spasi-text"><?php echo $data_urutDSC[$i]["content"] ?></p></td>
                                <td width="10%" align="center"><?php echo $data_urutDSC[$i]["similarity"] ?> %</td>
